		...
		<div class="m-auto max-w-6xl p-12">
			<div class="flex flex-col md:flex-row">
				<div class="md:w-1/2 max-w-md flex flex-col justify-center">
					...
					<AnchorLink href="#skills" class="text-green-700">- Skills</AnchorLink>
					<AnchorLink href="#hist" class="text-green-700">- History</AnchorLink>
					<AnchorLink href="#portfolio" class="text-green-700">- Portfolio</AnchorLink>
					{/* <div class="my-5 h-16">
				...
				<div class="flex md:justify-end w-full md:w-1/2 -mt-5">
					<div class="bg-dots">
						...
						<img alt="card img" class="rounded bg-green-100" src={faceImg} onError={(e) => e.target.src = noimage}/>
					...
					<div class="text-gray-900 font-bold text-3xl text-green-900 mb-3">Toyoshima Hidenori</div>
						<p class="text-gray-700 text-base">豊橋技術科学大学 情報知能工学専攻 博士前期課程1年所属</p>
							...
							<div class="flex items-center">
								<div class="ml-1">
									<a href="https://twitter.com/Toyoshima_Hi" class="block mt-3 inline-block lg:mt-0 p-2 text-black hover:text-green-600 mr-4">
									...
									<a href="https://github.com/ToyoshimaHidenori/ToyoshimaHidenori.github.io" class="block mt-3 inline-block lg:mt-0 p-2 text-black hover:text-green-600 mr-4">
