		...
		<div class="m-auto max-w-6xl p-12">
			<div class="flex flex-col md:flex-row">
				<div class="md:w-1/2 max-w-md flex flex-col justify-center">
					<div class="md:text-5xl text-2xl uppercase font-black">はじめまして</div>
					<div class="text-xl mt-4">情報工学に興味のある大学生です。まずは気軽にフォローしてください !</div>
					<div class="my-5 h-16">
				...
				<div class="flex md:justify-end w-full md:w-1/2 -mt-5">
					<div class="bg-dots">
						...
						<img alt="card img" class="rounded bg-blue-100" src={faceImg}/> 
						<div class="text-2xl p-10 bg-white">
											<div class="mb-8">
					<div class="text-gray-900 font-bold text-4xl text-green-900 mb-3">Toyoshima Hidenori</div>
						<p class="text-gray-700 text-base">豊橋技術科学大学 情報知能工学課程 学部4年所属</p>
							</div>
